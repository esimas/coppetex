...
Diversos algoritmos foram propostos na literatura para estimação do modelo PNL ...
...
medidos em um conjunto de sensores químicos. Em ...
...
Considerando um problema de classificação, o modelo da ICA/NLICA não foi originalmente desenvolvido para extração de 
...
pré-processamento dependem da base de dados utilizada. 

Neste trabalho foram utilizadas algumas modificações no processo de estimação da NLICA, de modo 
a utilizar o conhecimento prévio dos rótulos de classe dos dados. Assim, pretende-se obter componentes independentes 
com características discriminantes, contribuindo para o aumento da eficiência de classificação.

... descrever brevemente os tópicos abaixo ...
...
No trabalho \cite{article:icaClasp:2003} foi proposta a utilização dos rótulos de classes como entrada para ...

\subsection{Proposta de algoritmo para estimação de componentes independentes e discriminantes}
