...
variável). A análise deste
modelo a partir da teoria da análise funcional
(\textit{functional analysis})~
\cite{book:function:1984}, mostra 
que esta arquitetura pode representar qualquer mistura com duas camadas de não-linearidades~\cite{article:gao:nl2005}.
