...
... mostrar aplicações de ICA e NLICA (fazer uma revisão, ver os tutoriais) ...

A seguir serão descritas algumas aplicações de técnicas de aprendizado estatístico em Física 
de Alta Energia (HEP - \textit{High-Energy Physics}) e áreas correlatas. 
