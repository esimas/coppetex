...
$\eta$ \> Pseudo-rapidez\\
$\theta$ \> Ângulo polar no sistema de coordenadas do ATLAS\\
$\lambda(.)$ \> Razão de semelhança\\
$\phi$ \> Ângulo azimutal no sistema de coordenadas do ATLAS\\
$e^-/j$ \> Elétron/Jato\\
...
optou-se por manter as mesmas em ingl\a^es.
...
SUSY \> Supersimetria\\
T2Calo \> Algoritmo de discriminação do HLT do ATLAS\\
