...
interesse são elétrons isolados distribuídos uniformemente na faixa
...
de eventos de interesse. Na Figura~\ref{fig_lumEc} pode-se observar a variação das 
...
\begin{minipage}[b]{0.48\linewidth}
  \centering
  \centerline
 \centerline{\epsfig{file=exp1_evE,width=7.2cm}}
\end{minipage}
\hfill
\begin{minipage}[b]{0.48\linewidth}
  \centering
  \centerline
 \centerline{\epsfig{file=exp1_evJ,width=7.2cm}}
\end{minipage}
\caption{Sinais experimentais médios de elétrons e jatos.}\label{fig_exp_compEvMed}
\end{figure}
