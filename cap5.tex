...
desempenho em termos de algumas variáveis físicas de interesse
como energia e posição de interação no detector (considerando os
eixos $\eta$ e $\phi$ do sistema de coordenadas do ATLAS).
...
Com o início das colisões do LHC (a partir do final de 2009), foi possível adquirir dados
experimentais. Uma outra classe de sinais utilizada para teste dos
