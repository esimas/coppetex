...
Monte Carlo~\cite{book:montecarlo:2004} pela colaboração do ATLAS, utilizando os simuladores
...
gravadas foram, então, submetidas à análise \emph{offline}. A filtragem de primeiro 
...
Os eventos aprovados no corte EM2 do primeiro nível (eventos que depositaram mais de 
