...
$10^{32}cm^{-2}s^{-1}$. Comparando com os valores nominais de
...
trabalho aplicando-se a metodologia proposta aos conjuntos de
sinais apresentados. Inicialmente serão abordados os dados
