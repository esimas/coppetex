...
de material instalado entre o ponto de colisão e o sistema de calorímetros, que provoca severas perdas na medição da 
energia de elétrons, conforme mostrado na Figura \ref{cap3_fig_enloss}. 
...
são mostrados na Figura \ref{cap3_enres}. Devido a características construtivas do detector, na 
região de transição entre o barril e a tampa do calorímetro 
(entre $\eta=1.37$ e $\eta=1.52$, conhecido como \textit{crack}), a resolução da energia é bastante 
degradada. Percebe-se que a precisão diminui para baixa energia e próximo ao 
...
eletromagnético, porém, eventos que insidem na região do crack, por encontrarem menor quantidade de material para 
interagirem, podem alcançar o calorímetro hadrônico. Conforme ilustrado na Figura \ref{fig_envazahad}, a energia de 
...
Essa limitação pode provocar problemas para o sistema de filtragem, como será descrito a seguir.
