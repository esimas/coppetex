...
da energia concentrada em janelas de $3 \times 7$ células
  ...
  \item A energia hadrônica total: $E^{HAD}$ é
...
patamar de corte pré-estabelecido. Para $E^{HAD}$, acontece o inverso, e um candidato a elétron é selecionado 
...
Os sinais em anéis são normalizados fazendo-se...
...
Um aspecto crucial dos algoritmos para o sistema filtragem online é o tempo de execução. No caso do 
