...
componentes independentes (ICA e NLICA), foram empregadas versões
treinadas para o conjunto de elétrons e jatos com corte E10 (pois
esse conjunto, comparado ao E15i, apresenta maior estatística em
...
para os discriminadores com pré-processamento por ICA, SOM e PNL
são mostradas na Figura~\ref{figcosmicNNo} (no treinamento foi
...
de rejeição (abaixo) para eventos de raios
cósmicos.}\label{figcosmicBarC}
\end{figure}
...
pré-processamento por ICA/NLICA produz uma eficiência
aproximadamente constante, reduzindo a flutuação em relação ao
\emph{Neural Ringer}. Resultados semelhantes são observados para
as outras duas grandezas ($\eta$ e $\phi$).
...
%  \centerline{\footnotesize Elétrons/Simulados-E10}\medskip
 \centerline{\epsfig{file=exp1ringer_outs,width=8cm}}
\end{minipage}
\hfill
\begin{minipage}[b]{0.48\linewidth}
  \centering
%  \centerline{\footnotesize Jatos/Simulados-E10}\medskip
 \centerline{\epsfig{file=exp1_fisherOuts,width=8cm}}
\end{minipage}
\begin{minipage}[b]{0.98\linewidth}
  \centering
...
Na Figura~\ref{fig_compRingerT2Loose} é apresentada uma comparação entre a eficiência e  
o falso-alarme obtidos para o corte T2EM3\_\emph{Loose} e para o \emph{Neural Ringer} ajustado para 
...
\begin{minipage}[b]{0.48\linewidth}
 ...
 \centerline{\epsfig{file=exp1ringer_t2etCompLoose,width=8cm}}
\end{minipage}
\hfill
\begin{minipage}[b]{0.48\linewidth}
  \centering
  \centerline{\footnotesize Falso alarme}\medskip
 \centerline{\epsfig{file=exp1ringer_t2etCompLooseFA,width=8cm}}
\end{minipage}
\begin{minipage}[b]{0.48\linewidth}
  \centering
%  \centerline{\footnotesize Elétrons/Simulados-E10}\medskip
 \centerline{\epsfig{file=exp1ringer_t2etaCompLoose,width=8cm}}
\end{minipage}
\hfill
\begin{minipage}[b]{0.48\linewidth}
  \centering
%  \centerline{\footnotesize Jatos/Simulados-E10}\medskip
 \centerline{\epsfig{file=exp1ringer_t2etaCompLooseFA,width=8cm}}
\end{minipage}
\hfill \caption{Distribuição das saídas para os discriminadores neural (esquerda e acima) e 
de Fisher (direita e acima) e as curvas ROC (abaixo).}\label{fig_compRingerT2Loose}
\end{figure}

Considerando agora o corte T2EM3\_\emph{Medium}, a Figura~\ref{fig_compRingerT2Medium} 
mostra que, de modo semelhante ao verificado para o critério T2EM3\_\emph{Loose}, 
para uma mesma probabilidade de detecção, o \emph{Neural Ringer} reduz significativamente 
o falso alarme de modo aproximadamente uniforme em energia. Analisando as distribuições em 
$\eta$, observa-se novamente que há uma inversão entre as regiões onde cada discriminador 
apresenta menor falso alarme.

\begin{figure}[ht]
\begin{minipage}[b]{0.48\linewidth}
  \centering
%  \centerline{\footnotesize Elétrons/Simulados-E10}\medskip
 \centerline{\epsfig{file=exp1ringer_t2etCompMedium,width=8cm}}
\end{minipage}
\hfill
\begin{minipage}[b]{0.48\linewidth}
  \centering
%  \centerline{\footnotesize Jatos/Simulados-E10}\medskip
 \centerline{\epsfig{file=exp1ringer_t2etCompMediumFA,width=8cm}}
\end{minipage}
\begin{minipage}[b]{0.48\linewidth}
  \centering
%  \centerline{\footnotesize Elétrons/Simulados-E10}\medskip
 \centerline{\epsfig{file=exp1ringer_t2etaCompMedium,width=8cm}}
\end{minipage}
\hfill
\begin{minipage}[b]{0.48\linewidth}
  \centering
%  \centerline{\footnotesize Jatos/Simulados-E10}\medskip
 \centerline{\epsfig{file=exp1ringer_t2etaCompMediumFA,width=8cm}}
\end{minipage}
\hfill \caption{Distribuição das saídas para os discriminadores neural (esquerda e acima) e 
de Fisher (direita e acima) e as curvas ROC (abaixo).}\label{fig_compRingerT2Medium}
\end{figure}
...
\begin{tabular}{c|c|c|c|c|c|c}
    \hline \hline
    \textbf{Discriminador} &\textbf{Máx. SP}$\times$100 & \textbf{PD} (\%)  & \textbf{PF} (\%) & \textbf{PF}$_{PD=93\%}$ & \textbf{PF}$_{PD=96\%}$ & \textbf{PF}$_{PD=98\%}$ \\
    \hline
  ...
  SOM Sup. & 86,26 $\pm$ 0,20 & 85,34 $\pm$ 0,29 & 12,81 $\pm$ 0,11 &  $\pm$ 0,17 & 40,65 $\pm$ &  $\pm$\\ \hline
   ...
   Local   & 86,67 $\pm$ 0,27 & 87,61 $\pm$ 0.30 & 14,22 $\pm$ 0,17 &  $\pm$ 0,10 & 42,02 $\pm$ &  $\pm$\\ \hline
Rede Comb. & 86,80 $\pm$ 0,23 & 89,44 $\pm$ 0.18 & 15,80 $\pm$ 0,10 &  $\pm$ 0,09 & 33,76 $\pm$ &  $\pm$\\ \hline
R.Comb. E1+E2 & 86,26 $\pm$ 0,21 & 87,50 $\pm$ 0,17 & 14,91 $\pm$ 0,14 &  $\pm$ 0,12& 39,48 $\pm$ &  $\pm$\\ \hline
 \hline
\end{tabular}
